    ...
    function getTimetableData(): {
      ...
      return {
        ...
        columns: [
          ...
          { key: 'main', label: text('主舞台', 'Main Stage'), min: '10em', grow: 1.25, color: '#efefef' },
          { key: 'workshop', label: text('工坊區', 'Workshop'), min: '7em', grow: 1, color: '#efefef' },
          { key: 'vendor', label: text('攤位街', 'Vendor Alley'), min: '6.5em', grow: 1, color: '#efefef' },
          { key: 'game', label: text('遊戲區', 'Game Area'), min: '7.5em', grow: 1.05, color: '#efefef' },
