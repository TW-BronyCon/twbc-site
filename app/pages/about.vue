        ...
        <div id="paperContent">
          ...
          >
            <div class="block">
              ...
              <p>
                ...
                <br>
                <NuxtLink :to="localePath({ path: '/about', query: { id: 'mascot' } })">
          ...
          >
            <div class="block">
              ...
              <div
                aria-label="Mascot"
                class="mascot-stage center-img"
              >
                <div class="mascot-idle-mask">
                  <img
                    alt=""
                    class="mascot-idle"
                    src="/img/Mascot_idle.avif"
                  >
                </div>
                <div class="mascot-hop-mask">
                  <img
                    alt=""
                    class="mascot-hopping"
                    src="/img/Mascot_hopping.avif"
                  >
                </div>
              </div>

              <h4 style="margin-top: 2em;">{{ t('about.sections.mascot.guardianTitle') }}</h4>
          ...
          >
            <div class="block">
              ...
              <h4 class="thanks-heading">
                {{ t('about.sections.thanks.staffTitle') }}
              </h4>

              <h5
                v-for="item in list('about.sections.thanks.staff')"
                :key="item"
              >
                {{ item }}
              </h5>
              ...
              <h5
                v-for="item in list('about.sections.thanks.volunteers')"
                :key="item"
              >
                {{ item }}
              </h5>
              ...
              <h5
                v-for="item in list('about.sections.thanks.special')"
                :key="item"
              >
                {{ item }}
              </h5>
